...
// import { any } from 'agora-rte-extension';
 ...
 * @param error
 */
declare function event_content_inspect_result (data?: "porn" | "sexy" | "neutral", error?: AgoraRTCError): void;
...
export declare interface IAgoraRTCClient extends EventEmitter {
    ...
    on (event: "content_inspect_result", listener: typeof event_content_inspect_result): void;
    on (event: string, listener: Function): void;
    /**
